export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'lblinkz',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lblinkz',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lblinkz.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lblinkz.com',
